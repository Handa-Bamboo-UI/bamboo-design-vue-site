...
<<<<<<< HEAD
        <bm-pin description="图钉1" type="primary" iconType="fa-home" menu iconOnly>
            <bm-pin-group direction="vertical" gap="0px" sub left sleep>
                ...
                <bm-pin description="图钉6" type="default" iconOnly iconType="arrow-up" ></bm-pin>
                <bm-pin description="图钉7" type="default" iconOnly iconType="arrow-down" ></bm-pin>
            </bm-pin-group>
        </bm-pin>
        <bm-pin description="图钉2" type="primary" menu iconOnly iconType="arrow-right" >
              <bm-pin-group direction="vertical" gap="8px" sub left sleep>
                <bm-pin description="图钉5" type="default" iconOnly iconType="arrow-left" ></bm-pin>
                <bm-pin description="图钉6" type="default" iconOnly iconType="arrow-up" ></bm-pin>
                <bm-pin description="图钉7" type="default" iconOnly iconType="arrow-down" ></bm-pin>
            </bm-pin-group>
